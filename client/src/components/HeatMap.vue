      ...
      if (this.team == "A") {
        if (this.parte == "1") {
          for (var i = 0; i < this.gamedata.teamA.players.length; i++)
            for (var j = 0; j <= 60; j++)
              this.teamdata[
                this.getPos(this.gamedata.teamA.players[i].pos[j].posY)
              ][this.getPos(this.gamedata.teamA.players[i].pos[j].posX)]++;
        } else {
          for (var i = 0; i < this.gamedata.teamA.players.length; i++)
        ...
        if (this.parte == "1") {
          for (var i = 0; i < this.gamedata.teamB.players.length; i++)
            for (var j = 0; j <= 60; j++)
              this.teamdata[
                this.getPos(this.gamedata.teamB.players[i].pos[j].posY)
              ][this.getPos(this.gamedata.teamA.players[i].pos[j].posX)]++;
        } else {
          for (var i = 0; i < this.gamedata.teamB.players.length; i++)
            for (var j = 61; j <= 120; j++)
